...
class ResourceLoaderStartUpModule extends ResourceLoaderModule {
	...
	public function getScript( ResourceLoaderContext $context ) {
		global $IP, $IP_BASE, $wgScriptPath, $wgLoadScript, $wgLegacyJavaScriptGlobals;

		$out = file_get_contents( "$IP/$IP_BASE/resources/startup.js" );
	...
	public function getModifiedTime( ResourceLoaderContext $context ) {
		global $IP, $IP_BASE, $wgScriptPath, $wgCacheEpoch;
		...
		$this->modifiedTime[$hash] = filemtime( "$IP/$IP_BASE/resources/startup.js" );
